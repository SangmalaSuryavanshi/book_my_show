...
public class TicketService {
    ...
    public String addTicket(TicketRequestDto ticketRequestDto) throws Exception{
        ...
        TicketEntity ticketEntity = TicketConvertor.convertTicketRequestDtoTicketEntity(ticketRequestDto);

        //Validation - check whether requested seats are available or not

        boolean isSeatsAvailable = checkRequestSeatsAvailability(ticketRequestDto);
        ...
        List<TicketEntity> ticketEntityList = showEntity.getListOfBookTickets();
        ticketEntityList.add(ticketEntity);
        showEntity.setListOfBookTickets(ticketEntityList);
        ...
        String bodyMail = "Hi this is to confirm your booking for seat no/s: "+allottedSeats+ " for the movie "+ticketEntity.getMovieName()+
                "and the show timings is : "+ticketEntity.getShowDateTime()+" and theater is "+ticketEntity.getTheaterName()+
                " and your total amount is "+ticketEntity.getTotalAmount();

        MimeMessage mimeMessage = javaMailSender.createMimeMessage();
        MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessage,true);
        mimeMessageHelper.setFrom("sangmalasurywanshi935@gmail.com");
    ...
    private String getAllottedSeats(List<String> requestedSeats){
        ...
        for (String seat : requestedSeats){
            result = result + seat +", ";//C1, C2, C3....
        }
        return result;
    }

    private Boolean checkRequestSeatsAvailability(TicketRequestDto ticketRequestDto){
