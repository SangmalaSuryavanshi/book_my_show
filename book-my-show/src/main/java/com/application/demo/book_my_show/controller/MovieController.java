...
public class MovieController {
    ...
    @GetMapping("/getMovieBasedOnMovieName")
    public ResponseEntity<?> getMovieBasedOnMovieName(@RequestParam String movieName){

        try{
            MovieEntity movieEntity = movieService.getMovieBasedOnMovieName(movieName);
